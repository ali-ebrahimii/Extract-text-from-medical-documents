...
class LabRowValidationService:
    def validate(self,row:LabResultV2, unsafe_ocr:bool=False)->LabResultV2:
        ...
        row.column_statuses.unit_status='valid' if row.unit else 'missing_optional'
        ...
        row.row_save_allowed=row.row_validation_status=='valid' and row.column_statuses.result_status=='valid'
        return row
