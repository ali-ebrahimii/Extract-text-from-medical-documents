...
CSV_COLUMNS=["filename","request_id","document_id","status","document_type","confidence","quality_score","quality_min_score","quality_worst_page_number","ocr_confidence","ocr_text_length","patient_name_found","national_id_hash_found","date_found","center_name_found","tracking_number_found","age_found","sex_found","test_or_report_name_found","lab_result_count","pap_smear_found","radiology_found","error_codes","warning_codes","ocr_warning_count"]
